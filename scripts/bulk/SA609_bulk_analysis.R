...
## First loading data from kallisto alignment output
...
## Second, loading dge counts files, filtering genes, compute size factors, and get normalized CPM output
