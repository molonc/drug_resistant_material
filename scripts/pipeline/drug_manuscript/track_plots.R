...
deg_fn <- paste0(input_dir,datatag,'/SA609_4_SA609_UTTTT_R_UUUUU_H/signif_genes_FDR_0.01.csv')
...
subtitle <- paste0(tag,': in cis DE genes, Rx X7:cloneA vs. UnRx X7:cloneH')
...
subtitle <- paste0(tag,': in trans DE genes, Rx X7:cloneA vs. UnRx X7:cloneH')
...
main_plot <- cowplot::plot_grid(
  track_intrans + theme(axis.title.x = element_blank(),
