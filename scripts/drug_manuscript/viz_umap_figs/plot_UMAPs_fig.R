...
plot_SA535 <- function(output_dir){
  ...
  datatag <- 'SA535'
  clonealign_stat <- data.table::fread(paste0(dirname(output_dir),'/clonealign_labels.csv.gz')) %>% as.data.frame()
...
plot_SA609 <- function(output_dir){
  ...
  p609_total <- cowplot::plot_grid(rna_SA609$UnRx_X4$p, rna_SA609$UnRx_X5$p, rna_SA609$UnRx_X6$p, rna_SA609$UnRx_X7$p,
                                   ...
                                   NULL, rna_SA609$RxH_X5$p,rna_SA609$RxH_X6$p, rna_SA609$RxH_X7$p,
                                   ncol=4, align = 'hv')
...
plot_SA1035 <- function(output_dir){
  ...
  # res_SA1035_UnRx$p,  # untreated
  # res_SA1035_Rx$p,   # treated
  # res_SA1035_RxH$p, res_dlp_SA1035_lg$plg
  ...
  p1035_total <- cowplot::plot_grid(rna_SA1035$UnRx_X5$p,rna_SA1035$UnRx_X6$p, rna_SA1035$UnRx_X7$p, rna_SA1035$UnRx_X8$p,
                                    ...
                                    NULL, rna_SA1035$RxH_X6$p, rna_SA1035$RxH_X7$p, rna_SA1035$RxH_X8$p,
                                    ncol=4, align = 'hv')
  # p609_total1 <- cowplot::plot_grid(res_SA609_Rx$plg, p609_total, ncol=1, rel_heights = c(1,10), labels = c('SA609',''))
  png(paste0(output_dir,datatag,".png"), height = 2*800, width=2*800,res = 2*72)
  print(p1035_total)
