...
base_dir <- '/home/htran/storage/datasets/drug_resistance/rna_results/SA609_rna/normalized/'
sce <- readRDS(paste0(base_dir,'SA609_raw.rds'))
saveRDS(sce, paste0(base_dir,'SA609_raw.rds'))
dim(sce)
