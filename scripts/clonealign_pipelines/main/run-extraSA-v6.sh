snakemake -s Snakefile-extraSA-v6 -j 10 -k -p --use-singularity --singularity-args "--home $HOME -B /cellassign/:/cellassign" --singularity-prefix /cellassign/fitness-scrna/docker/image/ $1
