snakemake -s Snakefile-SA906b -j 10 -k -p --use-singularity --singularity-args "--home $HOME -B /cellassign/:/cellassign" --singularity-prefix /cellassign/fitness-scrna/docker/image/ $1
