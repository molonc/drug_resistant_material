...
snakemake <- Snakemake(
    input = list('../../results/v3/outputs/preprocess/sce_annotated/SA906_p11a.rds', '../../results/v3/outputs/align_clones/clonealign_fit/SA906_p11a.rds', "sce" = '../../results/v3/outputs/preprocess/sce_annotated/SA906_p11a.rds', "clonealign_fit" = '../../results/v3/outputs/align_clones/clonealign_fit/SA906_p11a.rds'),
    output = list('../../results/v3/outputs/de/SA906_p11a_heatmap.png', '../../results/v3/outputs/de/SA906_p11a_findmarkers.rds', "fig" = '../../results/v3/outputs/de/SA906_p11a_heatmap.png', "rds" = '../../results/v3/outputs/de/SA906_p11a_findmarkers.rds'),
    params = list(c('D_F_H_I', 'C'), 'SA906_p11a', '../differential_expression', "interesting_clones" = c('D_F_H_I', 'C'), "sample" = 'SA906_p11a', "workspace" = '../differential_expression'),
    wildcards = list('SA906_p11a', "sample" = 'SA906_p11a'),
    threads = 1,
    log = list(),
    resources = list(),
