...
snakemake <- Snakemake(
    input = list('../../results/v2/outputs/preprocess/sce_annotated/SA906_p50b.rds', '../../data/external/recount2/rse_gene_breast.Rdata', "sce" = '../../results/v2/outputs/preprocess/sce_annotated/SA906_p50b.rds', "gtex" = '../../data/external/recount2/rse_gene_breast.Rdata'),
    output = list('../../results/v2/scratch/infercnv/SA906_p50b.rds', '../../results/v2/scratch/infercnv/SA906_p50b', "rds" = '../../results/v2/scratch/infercnv/SA906_p50b.rds', "infercnv_dir" = '../../results/v2/scratch/infercnv/SA906_p50b'),
    params = list(),
    wildcards = list('SA906_p50b', "sample" = 'SA906_p50b'),
    threads = 1,
    log = list('../../results/v2/logs/infercnv/infercnv/SA906_p50b.log'),
    resources = list(),
